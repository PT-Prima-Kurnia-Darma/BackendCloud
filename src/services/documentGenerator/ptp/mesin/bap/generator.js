...
const createBapPtpMesin = async (data) => {
    ...
    try {
        ...
        console.error('Gagal mengunduh template BAP PTP Mesin:', error);
        throw new Error('Template dokumen BAP PTP Mesin tidak dapat diakses.');
    }
...
module.exports = { createBapPtpMesin };