...
const bapProteksiKebakaranPayload = Joi.object({
    ...
    technicalData: Joi.object({
        ...
        totalSprinkler: Joi.string().allow('').optional(),
        ...
        aparCount: Joi.string().allow('').optional(),
        certificateString: Joi.string().allow('').optional(),
    }).optional(),
    ...
    testResults: Joi.object({
        visualInspection: Joi.object({
            ...
            arePumpsAvailable: Joi.boolean().allow(null).optional(),
            arePumpsInGoodCondition: Joi.boolean().allow(null).optional(),
