...
const createLaporanMobileCrane = async (data) => {
    ...
    const renderData = {
        ...
        // === III. PEMERIKSAAN VISUAL (SEMUA VARIABEL) ===
        ...
        safetyDevicesConverterAnemometerWindSpeedTidakMemuhi: getOppositeCheckmark(i.visualSafetyDevicesConverterAnemometerWindSpeedResult?.status),
    ...
    const fullRenderData = { ...data, ...data.generalData, ...data.technicalData, ...data.inspectionAndTesting, ...renderData };
