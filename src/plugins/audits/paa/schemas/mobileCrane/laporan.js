...
const createLaporanMobileCrane = async (data) => {
    ...
    const renderData = {
        ...
        dynamicMainHookTests: Joi.array().items(testItemSchema).optional(),
        dynamicAuxiliaryHookTests: Joi.array().items(testItemSchema).optional(),
        staticMainHookTests: Joi.array().items(testItemSchema).optional(),
        staticAuxiliaryHookTests: Joi.array().items(testItemSchema).optional(),
